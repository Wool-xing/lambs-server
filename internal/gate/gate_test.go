...
func TestHandleCheckIntegration(t *testing.T) {
	...
	mustExec(`CREATE TABLE projects (id TEXT PRIMARY KEY, name TEXT, base_path TEXT, status TEXT, port TEXT, backend_url TEXT, host TEXT NOT NULL DEFAULT '', services JSONB DEFAULT '[]', dsn TEXT)`)
